...
public class FirebaseRequestV2 {
	private String to;
//  private String condition;
  private FirebaseNotification data;
  private FirebaseNotificationMessage notification;

  public FirebaseRequestV2(){

  }

  public FirebaseRequestV2(String to, String title, String message, String topic, String clickAction, String screenMobile){
      this.to = to;
