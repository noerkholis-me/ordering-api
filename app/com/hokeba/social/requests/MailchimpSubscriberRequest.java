...
public class MailchimpSubscriberRequest {
	...
	public MailchimpSubscriberRequest(String email, String status, String fname, String lname, String bday) {
		email_address = email;
		this.status = status;
		merge_fields = new MailchimpMergeFields(fname, lname, bday);
	}
	
	public MailchimpSubscriberRequest() {
