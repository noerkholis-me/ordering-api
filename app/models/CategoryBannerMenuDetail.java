...
@Entity
@Table(name = "category_banner_menu_detail")
public class CategoryBannerMenuDetail extends BaseModel {

	private static final long serialVersionUID = 1L;
	public static final boolean ACTIVE = true;
	public static final boolean INACTIVE = false;
	private static final String LOG_TYPE = "ADMIN";
	private static final String LOG_TABLE_NAME = "category_banner_menu_detail";
	...
	public CategoryBannerMenu categoryBanner;
	...
	public static Finder<Long, CategoryBannerMenuDetail> find = new Finder<>(Long.class, CategoryBannerMenuDetail.class);
...
//	}
	...
	public static Page<CategoryBannerMenuDetail> page(int page, int pageSize, String sortBy, String order, String filter) {
		return
				find.where()
						.eq("is_deleted", false)
	...
	public static List<CategoryBannerMenuDetail> getAllChildCategory(Long id) {
		return CategoryBannerMenuDetail.find.where().eq("category_banner_id", id).eq("is_deleted", false).order("sequence asc").findList();
	}

	public static BannerList getDetails(String slug){
		CategoryBannerMenuDetail banner = CategoryBannerMenuDetail.find.where()
				.eq("is_deleted", false)
				.eq("slug", slug)
