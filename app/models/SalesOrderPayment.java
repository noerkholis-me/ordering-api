...
//    }
    ...
    public static Page<SalesOrderPayment> page(int page, int pageSize, String sortBy, String order, String name, String filter) {
        ExpressionList<SalesOrderPayment> qry = SalesOrderPayment.find
                .where()
                .ilike("salesOrder.orderNumber", "%" + name + "%")
    ...
    public static String generateInvoiceCode(){
        ...
        SalesOrderPayment so = SalesOrderPayment.find.where("t0.created_at > '"+simpleDateFormat2.format(new Date())+"-01 00:00:00' and invoice_no is not null")
