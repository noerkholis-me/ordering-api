...
EXPOSE 9001
ENTRYPOINT ["./target/universal/whiz-api-1.0-SNAPSHOT/bin/whiz-api", "-Dconfig.file=conf/application-prod.conf", "-Dhttp.port=9001", "-DapplyEvolutions.default=true", "-DapplyDownEvolutions.default=true"]
