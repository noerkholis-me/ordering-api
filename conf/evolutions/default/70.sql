...
create index if not exists ix_role_merchant_feature_141 on role_merchant_feature (feature_id);
...
create index if not exists ix_role_merchant_feature_role_142 on role_merchant_feature (role_merchant_id);
